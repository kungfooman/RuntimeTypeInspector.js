...
interfaces/aliases, enums, generics, classes, unions, tuples, rest params, TSX,
`import = require`); unsupported constructs like `namespace` are dropped with a
comment. See `test/ts2js.mjs` for the exact snapshot coverage.
